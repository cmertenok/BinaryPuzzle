...
public class DatabaseConnection {
    ...
    public static void setupDatabase() {
        try {
            ...
            System.out.println(Color.GREEN + "Connection available!" + Color.RESET);
...
//                                    "DROP TABLE IF EXISTS players;");
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS players(" +
                    ...
                    ");");
            System.out.println(Color.GREEN + "Table players created!" + Color.RESET);
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS game_info(" +
                    ...
                    ");");
            System.out.println(Color.GREEN + "Table game_info created!" + Color.RESET);
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS board_state(" +
                    ...
                    ");");
            System.out.println(Color.GREEN + "Table board_state created!" + Color.RESET);
            statement.close(); connection.close();
            System.out.println(Color.GREEN + "Connection closed!" + Color.RESET);
